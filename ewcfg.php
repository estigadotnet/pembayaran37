...
$CONFIG = [
	...
	"RANDOM_KEY" => '4CcMbu8yvdkIYW3Q', // Random key for encryption
	...
	"PROJECT_ID" => "{E35313A1-BDC4-466C-B9BC-088D7A329967}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_pembayaran3"]
	],
	...
	"AUDIT_TRAIL_TABLE_NAME" => "t304_audit_trail", // Audit trail table name
	"AUDIT_TRAIL_TABLE_VAR" => "t304_audit_trail", // Audit trail table var
	...
	"USER_LEVEL_DBID" => "DB",
	"USER_LEVEL_TABLE" => "`t302_userlevels`",
	...
	"USER_LEVEL_PRIV_TABLE" => "`t303_userlevelpermissions`",
	...
	"USER_TABLE_NAME" => "t301_employees",
