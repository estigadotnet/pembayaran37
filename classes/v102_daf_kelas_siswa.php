...
class v102_daf_kelas_siswa extends DbTable
{
	...
	public function __construct()
	{
		...
		// tsk
		$this->tsk = new DbField('v102_daf_kelas_siswa', 'v102_daf_kelas_siswa', 'x_tsk', 'tsk', '`tsk`', '`tsk`', 200, 113, -1, FALSE, '`tsk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tsk->Sortable = TRUE; // Allow sort
		$this->fields['tsk'] = &$this->tsk;

		// siswa
		$this->siswa = new DbField('v102_daf_kelas_siswa', 'v102_daf_kelas_siswa', 'x_siswa', 'siswa', '`siswa`', '`siswa`', 200, 94, -1, FALSE, '`siswa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
