...
class t101_daf_kelas extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('t101_daf_kelas', 't101_daf_kelas', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// tahun_ajaran_id
		$this->tahun_ajaran_id = new DbField('t101_daf_kelas', 't101_daf_kelas', 'x_tahun_ajaran_id', 'tahun_ajaran_id', '`tahun_ajaran_id`', '`tahun_ajaran_id`', 3, 11, -1, FALSE, '`tahun_ajaran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sekolah_id
		$this->sekolah_id = new DbField('t101_daf_kelas', 't101_daf_kelas', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', '`sekolah_id`', 3, 11, -1, FALSE, '`sekolah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kelas_id
		$this->kelas_id = new DbField('t101_daf_kelas', 't101_daf_kelas', 'x_kelas_id', 'kelas_id', '`kelas_id`', '`kelas_id`', 3, 11, -1, FALSE, '`kelas_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "t102_daf_kelas_siswa") {
			$detailUrl = $GLOBALS["t102_daf_kelas_siswa"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t101_daf_kelasview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t101_daf_kelasedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t101_daf_kelasadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
