...
class t304_audit_trail extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('t304_audit_trail', 't304_audit_trail', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('t304_audit_trail', 't304_audit_trail', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// script
		$this->script = new DbField('t304_audit_trail', 't304_audit_trail', 'x_script', 'script', '`script`', '`script`', 200, 80, -1, FALSE, '`script`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->script->Sortable = TRUE; // Allow sort
		$this->fields['script'] = &$this->script;

		// user
		$this->user = new DbField('t304_audit_trail', 't304_audit_trail', 'x_user', 'user', '`user`', '`user`', 200, 80, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user->Sortable = TRUE; // Allow sort
		$this->fields['user'] = &$this->user;

		// action
		$this->_action = new DbField('t304_audit_trail', 't304_audit_trail', 'x__action', 'action', '`action`', '`action`', 200, 80, -1, FALSE, '`action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_action->Sortable = TRUE; // Allow sort
		$this->fields['action'] = &$this->_action;

		// table
		$this->_table = new DbField('t304_audit_trail', 't304_audit_trail', 'x__table', 'table', '`table`', '`table`', 200, 80, -1, FALSE, '`table`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_table->Sortable = TRUE; // Allow sort
		$this->fields['table'] = &$this->_table;

		// field
		$this->field = new DbField('t304_audit_trail', 't304_audit_trail', 'x_field', 'field', '`field`', '`field`', 200, 80, -1, FALSE, '`field`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field->Sortable = TRUE; // Allow sort
		$this->fields['field'] = &$this->field;

		// keyvalue
		$this->keyvalue = new DbField('t304_audit_trail', 't304_audit_trail', 'x_keyvalue', 'keyvalue', '`keyvalue`', '`keyvalue`', 201, -1, -1, FALSE, '`keyvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keyvalue->Sortable = TRUE; // Allow sort
		$this->fields['keyvalue'] = &$this->keyvalue;

		// oldvalue
		$this->oldvalue = new DbField('t304_audit_trail', 't304_audit_trail', 'x_oldvalue', 'oldvalue', '`oldvalue`', '`oldvalue`', 201, -1, -1, FALSE, '`oldvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->oldvalue->Sortable = TRUE; // Allow sort
		$this->fields['oldvalue'] = &$this->oldvalue;

		// newvalue
		$this->newvalue = new DbField('t304_audit_trail', 't304_audit_trail', 'x_newvalue', 'newvalue', '`newvalue`', '`newvalue`', 201, -1, -1, FALSE, '`newvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t304_audit_trailview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
