...
class v102_daf_kelas_siswa_list extends v102_daf_kelas_siswa
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "v102_daf_kelas_siswaadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	public function renderListOptions()
	{
		...
		// "detail_t103_daf_kelas_siswa_iuran"
		$opt = $this->ListOptions["detail_t103_daf_kelas_siswa_iuran"];
		if ($Security->allowList(CurrentProjectID() . 't103_daf_kelas_siswa_iuran')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("t103_daf_kelas_siswa_iuranlist.php?" . Config("TABLE_SHOW_MASTER") . "=v102_daf_kelas_siswa&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($links != "") {
		...
		// "detail_v110_bukti_master"
		$opt = $this->ListOptions["detail_v110_bukti_master"];
		if ($Security->allowList(CurrentProjectID() . 'v110_bukti_master')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("v110_bukti_masterlist.php?" . Config("TABLE_SHOW_MASTER") . "=v102_daf_kelas_siswa&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($links != "") {
				$body .= "<button class=\"dropdown-toggle btn btn-default ew-detail\" data-toggle=\"dropdown\"></button>";
				$body .= "<ul class=\"dropdown-menu\">". $links . "</ul>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fv102_daf_kelas_siswalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv102_daf_kelas_siswalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fv102_daf_kelas_siswalist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function loadSearchValues()
	{
		...
		// daf_kelas_id
		if (!$this->isAddOrEdit() && $this->daf_kelas_id->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->daf_kelas_id->AdvancedSearch->SearchValue != "" || $this->daf_kelas_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// siswa_id
		if (!$this->isAddOrEdit() && $this->siswa_id->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->siswa_id->AdvancedSearch->SearchValue != "" || $this->siswa_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// tsk
		if (!$this->isAddOrEdit() && $this->tsk->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->tsk->AdvancedSearch->SearchValue != "" || $this->tsk->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// siswa
		if (!$this->isAddOrEdit() && $this->siswa->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->siswa->AdvancedSearch->SearchValue != "" || $this->siswa->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		return $got;
	}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fv102_daf_kelas_siswalist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fv102_daf_kelas_siswalist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fv102_daf_kelas_siswalist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_v102_daf_kelas_siswa" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_v102_daf_kelas_siswa\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fv102_daf_kelas_siswalist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fv102_daf_kelas_siswalistsrch\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
