...
class r103_lap_um extends ReportTable
{
	...
	public function __construct()
	{
		...
		// Update Table
		$this->UpdateTable = "`v108_lap_um`";
		$this->ReportSourceTable = 'v108_lap_um'; // Report source table
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// tahunajaran
		$this->tahunajaran = new ReportField('r103_lap_um', 'r103_lap_um', 'x_tahunajaran', 'tahunajaran', '`tahunajaran`', '`tahunajaran`', 200, 9, -1, FALSE, '`tahunajaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->tahunajaran->Lookup = new Lookup('tahunajaran', 'v108_lap_um', TRUE, 'tahunajaran', ["tahunajaran","","",""], [], [], [], [], [], [], '', '');
		$this->tahunajaran->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->tahunajaran->SourceTableVar = 'v108_lap_um';
		$this->fields['tahunajaran'] = &$this->tahunajaran;

		// sekolahnama
		$this->sekolahnama = new ReportField('r103_lap_um', 'r103_lap_um', 'x_sekolahnama', 'sekolahnama', '`sekolahnama`', '`sekolahnama`', 200, 50, -1, FALSE, '`sekolahnama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->sekolahnama->Lookup = new Lookup('sekolahnama', 'v108_lap_um', TRUE, 'sekolahnama', ["sekolahnama","","",""], [], [], [], [], [], [], '', '');
		$this->sekolahnama->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->sekolahnama->SourceTableVar = 'v108_lap_um';
		$this->fields['sekolahnama'] = &$this->sekolahnama;

		// kelasnama
		$this->kelasnama = new ReportField('r103_lap_um', 'r103_lap_um', 'x_kelasnama', 'kelasnama', '`kelasnama`', '`kelasnama`', 200, 50, -1, FALSE, '`kelasnama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->kelasnama->Lookup = new Lookup('kelasnama', 'v108_lap_um', TRUE, 'kelasnama', ["kelasnama","","",""], [], [], [], [], [], [], '', '');
		$this->kelasnama->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->kelasnama->SourceTableVar = 'v108_lap_um';
		$this->fields['kelasnama'] = &$this->kelasnama;

		// nomorinduk
		$this->nomorinduk = new ReportField('r103_lap_um', 'r103_lap_um', 'x_nomorinduk', 'nomorinduk', '`nomorinduk`', '`nomorinduk`', 200, 25, -1, FALSE, '`nomorinduk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->nomorinduk->Lookup = new Lookup('nomorinduk', 'v108_lap_um', TRUE, 'nomorinduk', ["nomorinduk","siswanama","",""], [], [], [], [], [], [], '', '');
		$this->nomorinduk->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->nomorinduk->SourceTableVar = 'v108_lap_um';
		$this->fields['nomorinduk'] = &$this->nomorinduk;

		// siswanama
		$this->siswanama = new ReportField('r103_lap_um', 'r103_lap_um', 'x_siswanama', 'siswanama', '`siswanama`', '`siswanama`', 200, 50, -1, FALSE, '`siswanama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->siswanama->Lookup = new Lookup('siswanama', 'v108_lap_um', TRUE, 'siswanama', ["nomorinduk","siswanama","",""], [], [], [], [], [], [], '', '');
		$this->siswanama->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->siswanama->SourceTableVar = 'v108_lap_um';
		$this->fields['siswanama'] = &$this->siswanama;

		// iurannama
		$this->iurannama = new ReportField('r103_lap_um', 'r103_lap_um', 'x_iurannama', 'iurannama', '`iurannama`', '`iurannama`', 200, 25, -1, FALSE, '`iurannama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->iurannama->Sortable = TRUE; // Allow sort
		$this->iurannama->SelectMultiple = TRUE; // Multiple select
		$this->iurannama->Lookup = new Lookup('iurannama', 'v108_lap_um', TRUE, 'iurannama', ["iurannama","","",""], [], [], [], [], [], [], '', '');
		$this->iurannama->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->iurannama->SourceTableVar = 'v108_lap_um';
		$this->fields['iurannama'] = &$this->iurannama;

		// periodebayar
		$this->periodebayar = new ReportField('r103_lap_um', 'r103_lap_um', 'x_periodebayar', 'periodebayar', '`periodebayar`', '`periodebayar`', 3, 2, -1, FALSE, '`periodebayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->periodebayar->Sortable = TRUE; // Allow sort
		$this->periodebayar->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->periodebayar->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->periodebayar->Lookup = new Lookup('periodebayar', 'v108_lap_um', TRUE, 'periodebayar', ["periodebayar","","",""], [], [], [], [], [], [], '', '');
		$this->periodebayar->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->periodebayar->AdvancedSearch->SearchValueDefault = INIT_VALUE;
		$this->periodebayar->SourceTableVar = 'v108_lap_um';
		$this->fields['periodebayar'] = &$this->periodebayar;

		// jumlah_total
		$this->jumlah_total = new ReportField('r103_lap_um', 'r103_lap_um', 'x_jumlah_total', 'jumlah_total', '`jumlah_total`', '`jumlah_total`', 5, 19, -1, FALSE, '`jumlah_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jumlah_total->Sortable = TRUE; // Allow sort
		$this->jumlah_total->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->jumlah_total->SourceTableVar = 'v108_lap_um';
		$this->fields['jumlah_total'] = &$this->jumlah_total;

		// iuran_id
		$this->iuran_id = new ReportField('r103_lap_um', 'r103_lap_um', 'x_iuran_id', 'iuran_id', '`iuran_id`', '`iuran_id`', 3, 11, -1, FALSE, '`iuran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->iuran_id->SourceTableVar = 'v108_lap_um';
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v108_lap_um`";
	}
