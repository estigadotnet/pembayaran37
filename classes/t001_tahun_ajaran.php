...
class t001_tahun_ajaran extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('t001_tahun_ajaran', 't001_tahun_ajaran', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Mulai
		$this->Mulai = new DbField('t001_tahun_ajaran', 't001_tahun_ajaran', 'x_Mulai', 'Mulai', '`Mulai`', '`Mulai`', 200, 4, -1, FALSE, '`Mulai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Selesai
		$this->Selesai = new DbField('t001_tahun_ajaran', 't001_tahun_ajaran', 'x_Selesai', 'Selesai', '`Selesai`', '`Selesai`', 200, 4, -1, FALSE, '`Selesai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Aktif
		$this->Aktif = new DbField('t001_tahun_ajaran', 't001_tahun_ajaran', 'x_Aktif', 'Aktif', '`Aktif`', '`Aktif`', 202, 1, -1, FALSE, '`Aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t001_tahun_ajaranview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
