...
class t005_iuran extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('t005_iuran', 't005_iuran', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Nama
		$this->Nama = new DbField('t005_iuran', 't005_iuran', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, 25, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jenis
		$this->Jenis = new DbField('t005_iuran', 't005_iuran', 'x_Jenis', 'Jenis', '`Jenis`', '`Jenis`', 202, 9, -1, FALSE, '`Jenis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t005_iuranview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
