...
class t301_employees extends DbTable
{
	...
	public function __construct()
	{
		...
		// EmployeeID
		$this->EmployeeID = new DbField('t301_employees', 't301_employees', 'x_EmployeeID', 'EmployeeID', '`EmployeeID`', '`EmployeeID`', 3, 11, -1, FALSE, '`EmployeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// LastName
		$this->LastName = new DbField('t301_employees', 't301_employees', 'x_LastName', 'LastName', '`LastName`', '`LastName`', 200, 20, -1, FALSE, '`LastName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastName->Sortable = TRUE; // Allow sort
		$this->fields['LastName'] = &$this->LastName;

		// FirstName
		$this->FirstName = new DbField('t301_employees', 't301_employees', 'x_FirstName', 'FirstName', '`FirstName`', '`FirstName`', 200, 10, -1, FALSE, '`FirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FirstName->Sortable = TRUE; // Allow sort
		$this->fields['FirstName'] = &$this->FirstName;

		// Title
		$this->Title = new DbField('t301_employees', 't301_employees', 'x_Title', 'Title', '`Title`', '`Title`', 200, 30, -1, FALSE, '`Title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Title->Sortable = TRUE; // Allow sort
		$this->fields['Title'] = &$this->Title;

		// TitleOfCourtesy
		$this->TitleOfCourtesy = new DbField('t301_employees', 't301_employees', 'x_TitleOfCourtesy', 'TitleOfCourtesy', '`TitleOfCourtesy`', '`TitleOfCourtesy`', 200, 25, -1, FALSE, '`TitleOfCourtesy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TitleOfCourtesy->Sortable = TRUE; // Allow sort
		$this->fields['TitleOfCourtesy'] = &$this->TitleOfCourtesy;

		// BirthDate
		$this->BirthDate = new DbField('t301_employees', 't301_employees', 'x_BirthDate', 'BirthDate', '`BirthDate`', CastDateFieldForLike("`BirthDate`", 0, "DB"), 135, 19, 0, FALSE, '`BirthDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HireDate
		$this->HireDate = new DbField('t301_employees', 't301_employees', 'x_HireDate', 'HireDate', '`HireDate`', CastDateFieldForLike("`HireDate`", 0, "DB"), 135, 19, 0, FALSE, '`HireDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Address
		$this->Address = new DbField('t301_employees', 't301_employees', 'x_Address', 'Address', '`Address`', '`Address`', 200, 60, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address->Sortable = TRUE; // Allow sort
		$this->fields['Address'] = &$this->Address;

		// City
		$this->City = new DbField('t301_employees', 't301_employees', 'x_City', 'City', '`City`', '`City`', 200, 15, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->City->Sortable = TRUE; // Allow sort
		$this->fields['City'] = &$this->City;

		// Region
		$this->Region = new DbField('t301_employees', 't301_employees', 'x_Region', 'Region', '`Region`', '`Region`', 200, 15, -1, FALSE, '`Region`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Region->Sortable = TRUE; // Allow sort
		$this->fields['Region'] = &$this->Region;

		// PostalCode
		$this->PostalCode = new DbField('t301_employees', 't301_employees', 'x_PostalCode', 'PostalCode', '`PostalCode`', '`PostalCode`', 200, 10, -1, FALSE, '`PostalCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PostalCode->Sortable = TRUE; // Allow sort
		$this->fields['PostalCode'] = &$this->PostalCode;

		// Country
		$this->Country = new DbField('t301_employees', 't301_employees', 'x_Country', 'Country', '`Country`', '`Country`', 200, 15, -1, FALSE, '`Country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Country->Sortable = TRUE; // Allow sort
		$this->fields['Country'] = &$this->Country;

		// HomePhone
		$this->HomePhone = new DbField('t301_employees', 't301_employees', 'x_HomePhone', 'HomePhone', '`HomePhone`', '`HomePhone`', 200, 24, -1, FALSE, '`HomePhone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HomePhone->Sortable = TRUE; // Allow sort
		$this->fields['HomePhone'] = &$this->HomePhone;

		// Extension
		$this->Extension = new DbField('t301_employees', 't301_employees', 'x_Extension', 'Extension', '`Extension`', '`Extension`', 200, 4, -1, FALSE, '`Extension`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Extension->Sortable = TRUE; // Allow sort
		$this->fields['Extension'] = &$this->Extension;

		// Email
		$this->_Email = new DbField('t301_employees', 't301_employees', 'x__Email', 'Email', '`Email`', '`Email`', 200, 30, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Email->Sortable = TRUE; // Allow sort
		$this->fields['Email'] = &$this->_Email;

		// Photo
		$this->Photo = new DbField('t301_employees', 't301_employees', 'x_Photo', 'Photo', '`Photo`', '`Photo`', 200, 255, -1, FALSE, '`Photo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Photo->Sortable = TRUE; // Allow sort
		$this->fields['Photo'] = &$this->Photo;

		// Notes
		$this->Notes = new DbField('t301_employees', 't301_employees', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 201, -1, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Notes->Sortable = TRUE; // Allow sort
		$this->fields['Notes'] = &$this->Notes;

		// ReportsTo
		$this->ReportsTo = new DbField('t301_employees', 't301_employees', 'x_ReportsTo', 'ReportsTo', '`ReportsTo`', '`ReportsTo`', 3, 11, -1, FALSE, '`ReportsTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Password
		$this->Password = new DbField('t301_employees', 't301_employees', 'x_Password', 'Password', '`Password`', '`Password`', 200, 50, -1, FALSE, '`Password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UserLevel
		$this->UserLevel = new DbField('t301_employees', 't301_employees', 'x_UserLevel', 'UserLevel', '`UserLevel`', '`UserLevel`', 3, 11, -1, FALSE, '`UserLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Username
		$this->Username = new DbField('t301_employees', 't301_employees', 'x_Username', 'Username', '`Username`', '`Username`', 200, 20, -1, FALSE, '`Username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Activated
		$this->Activated = new DbField('t301_employees', 't301_employees', 'x_Activated', 'Activated', '`Activated`', '`Activated`', 202, 1, -1, FALSE, '`Activated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Profile
		$this->Profile = new DbField('t301_employees', 't301_employees', 'x_Profile', 'Profile', '`Profile`', '`Profile`', 201, -1, -1, FALSE, '`Profile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t301_employeesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
