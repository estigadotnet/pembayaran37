...
/**
 * Table class for v108_lap_um
 */
class v108_lap_um extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v108_lap_um';
		$this->TableName = 'v108_lap_um';
		$this->TableType = 'VIEW';
		...
		// tahunajaran
		$this->tahunajaran = new DbField('v108_lap_um', 'v108_lap_um', 'x_tahunajaran', 'tahunajaran', '`tahunajaran`', '`tahunajaran`', 200, 9, -1, FALSE, '`tahunajaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tahunajaran->Sortable = TRUE; // Allow sort
		$this->fields['tahunajaran'] = &$this->tahunajaran;

		// sekolahnama
		$this->sekolahnama = new DbField('v108_lap_um', 'v108_lap_um', 'x_sekolahnama', 'sekolahnama', '`sekolahnama`', '`sekolahnama`', 200, 50, -1, FALSE, '`sekolahnama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sekolahnama->Sortable = TRUE; // Allow sort
		$this->fields['sekolahnama'] = &$this->sekolahnama;

		// kelasnama
		$this->kelasnama = new DbField('v108_lap_um', 'v108_lap_um', 'x_kelasnama', 'kelasnama', '`kelasnama`', '`kelasnama`', 200, 50, -1, FALSE, '`kelasnama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kelasnama->Sortable = TRUE; // Allow sort
		$this->fields['kelasnama'] = &$this->kelasnama;

		// iurannama
		$this->iurannama = new DbField('v108_lap_um', 'v108_lap_um', 'x_iurannama', 'iurannama', '`iurannama`', '`iurannama`', 200, 25, -1, FALSE, '`iurannama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->iurannama->Sortable = TRUE; // Allow sort
		$this->fields['iurannama'] = &$this->iurannama;

		// iuran_id
		$this->iuran_id = new DbField('v108_lap_um', 'v108_lap_um', 'x_iuran_id', 'iuran_id', '`iuran_id`', '`iuran_id`', 3, 11, -1, FALSE, '`iuran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nomorinduk
		$this->nomorinduk = new DbField('v108_lap_um', 'v108_lap_um', 'x_nomorinduk', 'nomorinduk', '`nomorinduk`', '`nomorinduk`', 200, 25, -1, FALSE, '`nomorinduk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomorinduk->Sortable = TRUE; // Allow sort
		$this->fields['nomorinduk'] = &$this->nomorinduk;

		// siswanama
		$this->siswanama = new DbField('v108_lap_um', 'v108_lap_um', 'x_siswanama', 'siswanama', '`siswanama`', '`siswanama`', 200, 50, -1, FALSE, '`siswanama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->siswanama->Sortable = TRUE; // Allow sort
		$this->fields['siswanama'] = &$this->siswanama;

		// periodebayar
		$this->periodebayar = new DbField('v108_lap_um', 'v108_lap_um', 'x_periodebayar', 'periodebayar', '`periodebayar`', '`periodebayar`', 3, 2, -1, FALSE, '`periodebayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlah_total
		$this->jumlah_total = new DbField('v108_lap_um', 'v108_lap_um', 'x_jumlah_total', 'jumlah_total', '`jumlah_total`', '`jumlah_total`', 5, 19, -1, FALSE, '`jumlah_total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->periodebayar->DbValue = $row['periodebayar'];
	...
	{
		global $Language;
		if ($pageName == "v108_lap_umview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v108_lap_umedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v108_lap_umadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v108_lap_umview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v108_lap_umview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v108_lap_umadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v108_lap_umadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v108_lap_umedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v108_lap_umadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v108_lap_umdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->periodebayar->setDbValue($rs->fields('periodebayar'));
	...
	public function renderEditRow()
	{
		...
		// periodebayar
		$this->periodebayar->EditAttrs["class"] = "form-control";
		$this->periodebayar->EditCustomAttributes = "";
		$this->periodebayar->EditValue = $this->periodebayar->CurrentValue;
		$this->periodebayar->PlaceHolder = RemoveHtml($this->periodebayar->caption());
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->periodebayar);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->periodebayar);
