...
/**
 * Table class for v105_lap_bayar
 */
class v105_lap_bayar extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v105_lap_bayar';
		$this->TableName = 'v105_lap_bayar';
		$this->TableType = 'VIEW';
		...
		// daf_kelas_siswa_id
		$this->daf_kelas_siswa_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_daf_kelas_siswa_id', 'daf_kelas_siswa_id', '`daf_kelas_siswa_id`', '`daf_kelas_siswa_id`', 3, 11, -1, FALSE, '`daf_kelas_siswa_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// iuran_id
		$this->iuran_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_iuran_id', 'iuran_id', '`iuran_id`', '`iuran_id`', 3, 11, -1, FALSE, '`iuran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Jumlah
		$this->Jumlah = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_Jumlah', 'Jumlah', '`Jumlah`', '`Jumlah`', 4, 14, -1, FALSE, '`Jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Periode
		$this->Periode = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_Periode', 'Periode', '`Periode`', '`Periode`', 3, 2, -1, FALSE, '`Periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PeriodeBulan
		$this->PeriodeBulan = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_PeriodeBulan', 'PeriodeBulan', '`PeriodeBulan`', '`PeriodeBulan`', 200, 9, -1, FALSE, '`PeriodeBulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StatusBayar
		$this->StatusBayar = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_StatusBayar', 'StatusBayar', '`StatusBayar`', '`StatusBayar`', 200, 1, -1, FALSE, '`StatusBayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// JumlahBayar
		$this->JumlahBayar = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_JumlahBayar', 'JumlahBayar', '`JumlahBayar`', '`JumlahBayar`', 4, 14, -1, FALSE, '`JumlahBayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TglBayar
		$this->TglBayar = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_TglBayar', 'TglBayar', '`TglBayar`', CastDateFieldForLike("`TglBayar`", 0, "DB"), 133, 10, 0, FALSE, '`TglBayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// siswa_id
		$this->siswa_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_siswa_id', 'siswa_id', '`siswa_id`', '`siswa_id`', 3, 11, -1, FALSE, '`siswa_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NomorInduk
		$this->NomorInduk = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_NomorInduk', 'NomorInduk', '`NomorInduk`', '`NomorInduk`', 200, 25, -1, FALSE, '`NomorInduk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NomorInduk->Sortable = TRUE; // Allow sort
		$this->fields['NomorInduk'] = &$this->NomorInduk;

		// SiswaNama
		$this->SiswaNama = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_SiswaNama', 'SiswaNama', '`SiswaNama`', '`SiswaNama`', 200, 50, -1, FALSE, '`SiswaNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SiswaNama->Sortable = TRUE; // Allow sort
		$this->fields['SiswaNama'] = &$this->SiswaNama;

		// dk_id
		$this->dk_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_dk_id', 'dk_id', '`dk_id`', '`dk_id`', 3, 11, -1, FALSE, '`dk_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// kelas_id
		$this->kelas_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_kelas_id', 'kelas_id', '`kelas_id`', '`kelas_id`', 3, 11, -1, FALSE, '`kelas_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// KelasNama
		$this->KelasNama = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_KelasNama', 'KelasNama', '`KelasNama`', '`KelasNama`', 200, 50, -1, FALSE, '`KelasNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KelasNama->Sortable = TRUE; // Allow sort
		$this->fields['KelasNama'] = &$this->KelasNama;

		// sekolah_id
		$this->sekolah_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', '`sekolah_id`', 3, 11, -1, FALSE, '`sekolah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SekolahNama
		$this->SekolahNama = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_SekolahNama', 'SekolahNama', '`SekolahNama`', '`SekolahNama`', 200, 50, -1, FALSE, '`SekolahNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SekolahNama->Sortable = TRUE; // Allow sort
		$this->fields['SekolahNama'] = &$this->SekolahNama;

		// tahun_ajaran_id
		$this->tahun_ajaran_id = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_tahun_ajaran_id', 'tahun_ajaran_id', '`tahun_ajaran_id`', '`tahun_ajaran_id`', 3, 11, -1, FALSE, '`tahun_ajaran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TahunAjaran
		$this->TahunAjaran = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_TahunAjaran', 'TahunAjaran', '`TahunAjaran`', '`TahunAjaran`', 200, 9, -1, FALSE, '`TahunAjaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TahunAjaran->Sortable = TRUE; // Allow sort
		$this->fields['TahunAjaran'] = &$this->TahunAjaran;

		// IuranNama
		$this->IuranNama = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_IuranNama', 'IuranNama', '`IuranNama`', '`IuranNama`', 200, 25, -1, FALSE, '`IuranNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IuranNama->Sortable = TRUE; // Allow sort
		$this->fields['IuranNama'] = &$this->IuranNama;

		// keterangan
		$this->keterangan = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 193, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// IuranNama2
		$this->IuranNama2 = new DbField('v105_lap_bayar', 'v105_lap_bayar', 'x_IuranNama2', 'IuranNama2', '`IuranNama2`', '`IuranNama2`', 200, 39, -1, FALSE, '`IuranNama2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "v105_lap_bayarview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v105_lap_bayaredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v105_lap_bayaradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v105_lap_bayarview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v105_lap_bayarview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v105_lap_bayaradd.php?" . $this->getUrlParm($parm);
		else
			$url = "v105_lap_bayaradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v105_lap_bayaredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v105_lap_bayaradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v105_lap_bayardelete.php", $this->getUrlParm());
	}
