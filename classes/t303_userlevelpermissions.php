...
class t303_userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// userlevelid
		$this->userlevelid = new DbField('t303_userlevelpermissions', 't303_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('t303_userlevelpermissions', 't303_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 255, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('t303_userlevelpermissions', 't303_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, 11, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("t303_userlevelpermissionsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
