...
<?php if ($t003_kelas_delete->Nama->Visible) { // Nama ?>
		<th class="<?php echo $t003_kelas_delete->Nama->headerCellClass() ?>"><span id="elh_t003_kelas_Nama" class="t003_kelas_Nama"><?php echo $t003_kelas_delete->Nama->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($t003_kelas_delete->Nama->Visible) { // Nama ?>
		<td <?php echo $t003_kelas_delete->Nama->cellAttributes() ?>>
<span id="el<?php echo $t003_kelas_delete->RowCount ?>_t003_kelas_Nama" class="t003_kelas_Nama">
<span<?php echo $t003_kelas_delete->Nama->viewAttributes() ?>><?php echo $t003_kelas_delete->Nama->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
