...
?>
<?php if ($t003_kelas_list->Nama->Visible) { // Nama ?>
	<?php if ($t003_kelas_list->SortUrl($t003_kelas_list->Nama) == "") { ?>
		<th data-name="Nama" class="<?php echo $t003_kelas_list->Nama->headerCellClass() ?>"><div id="elh_t003_kelas_Nama" class="t003_kelas_Nama"><div class="ew-table-header-caption"><?php echo $t003_kelas_list->Nama->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Nama" class="<?php echo $t003_kelas_list->Nama->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t003_kelas_list->SortUrl($t003_kelas_list->Nama) ?>', 2);"><div id="elh_t003_kelas_Nama" class="t003_kelas_Nama">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t003_kelas_list->Nama->caption() ?></span><span class="ew-table-header-sort"><?php if ($t003_kelas_list->Nama->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t003_kelas_list->Nama->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($t003_kelas_list->Nama->Visible) { // Nama ?>
		<td data-name="Nama" <?php echo $t003_kelas_list->Nama->cellAttributes() ?>>
<span id="el<?php echo $t003_kelas_list->RowCount ?>_t003_kelas_Nama">
<span<?php echo $t003_kelas_list->Nama->viewAttributes() ?>><?php echo $t003_kelas_list->Nama->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
